...
namespace PrjAdoFirstApplication
{
    class DisconnectedArchitecture
    {
        static void Main()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select * from shippers;select * from categories;select * from suppliers", con);
            ...
            foreach (var item in ds.Tables)
            {
                ...
                Console.WriteLine("Printing the contents of {0}", item.ToString());
