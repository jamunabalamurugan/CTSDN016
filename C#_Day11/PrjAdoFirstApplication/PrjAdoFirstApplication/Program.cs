...
namespace PrjAdoFirstApplication
{
    class StudentDAL
    {
        ...
        public StudentDAL()
        {
            ...
            conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbStudycon"].ConnectionString);
            //conn.Open();
            //Console.WriteLine("Connection success");
        }
        public void GetStudentsDataFromDatabase()
        {
        ...
        public void DeleteStudentRecordFromDatabase()
        {
    ...
    class StudentClient
    {
        ...
        {
            StudentDAL program = new StudentDAL();
