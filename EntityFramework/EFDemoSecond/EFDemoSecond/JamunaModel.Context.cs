...
namespace EFDemoSecond
{
    ...
    public partial class JamunaCon : DbContext
    {
        public JamunaCon()
            : base("name=JamunaCon")
        {
        ...
        public virtual ObjectResult<stockstatus_Result> stockstatus()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<stockstatus_Result>("stockstatus");
        }
